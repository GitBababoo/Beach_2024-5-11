...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $confirm_password) {
        ...
        try {
            ...
            $role_id = 2; // กำหนด role_id เป็น 2 สำหรับผู้ใช้ทั่วไป
