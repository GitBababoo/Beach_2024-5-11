...
// Note: Don't close connection here - it's a shared component used by other pages
?>
...
<nav class="navbar navbar-expand-lg navbar-custom fixed-top">
    <div class="container">
        <a class="navbar-brand" href="index.php">หาดสะอาดด้วยมือเรา</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-custom" href="ข้อมูลหาดทรายน้อย.php">
                        <i class="bi bi-gift"></i>  ข้อมูลหาดทรายน้อย
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-custom" href="ที่มาโครงการ.php">
                        <i class="bi bi-book"></i> ที่มาโครงการ
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-custom" href="ภาพบรรยากาศโครงการ.php">
                        <i class="bi bi-camera"></i> ภาพบรรยากาศโครงการ
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-custom" href="ธุรกิจชุมชน.php">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end text-center dropdown-menu-custom" aria-labelledby="profileDropdown">
                            ...
                            <?php if ($userProfile['role'] === 'admin'): ?>
                                <li><a class="dropdown-item dropdown-item-custom" href="Admin/admin_Dashboard.php"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                            <?php endif; ?>
                            <li><a class="dropdown-item dropdown-item-custom" href="profile.php"><i class="bi bi-pencil"></i> โปรไฟล์</a></li>
                            <li><a class="dropdown-item dropdown-item-custom" href="logout.php"><i class="bi bi-box-arrow-right"></i> ออกจากระบบ</a></li>
                        </ul>
                    </div>
                <?php else: ?>
                    <ul class="navbar-nav">
