...
// Store all rows in array for reliable looping
$businesses = [];
    ...
    <?php if (count($businesses) > 0): ?>
        ...
        <?php foreach($businesses as $row): ?>
            <div class="neumorphic p-4 d-flex <?php echo $isOdd ? '' : 'flex-row-reverse'; ?>">
                ...
                $firstPhoto = !empty($photos[0]) ? htmlspecialchars($photos[0]) : 'default.jpg';
                ?>
                <img src="uploads/<?php echo $firstPhoto; ?>" alt="Business Photo" class="business-img" onerror="this.src='default.png'" />
                <div>
