...
// Use absolute base path for all admin links
$adminBase = '/Beach_2024-5-11/Admin/';
?>
...
<div class="flex">
    <div class="w-1/4 bg-gradient-to-b from-blue-900 via-blue-800 to-indigo-700 h-screen p-6 shadow-2xl rounded-tr-3xl rounded-br-3xl backdrop-blur-lg bg-opacity-80 border border-white/10">
        ...
        <ul class="space-y-4">
            <?php
            $menuItems = [
                ['link' => $adminBase . 'admin_Dashboard.php', 'icon' => 'fas fa-tachometer-alt', 'label' => 'แดชบอร์ด'],
                ['link' => $adminBase . 'users/users.php', 'icon' => 'fas fa-user-friends', 'label' => 'ผู้ใช้'],
                ['link' => $adminBase . 'cleanup_activities/cleanup_activities.php', 'icon' => 'fas fa-recycle', 'label' => 'เก็บขยะ'],
                ['link' => $adminBase . 'cleanup_photos/cleanup_photos.php', 'icon' => 'fas fa-image', 'label' => 'รูปภาพกิจกรรม'],
                ['link' => $adminBase . 'waste_types/waste_types.php', 'icon' => 'fas fa-trash-alt', 'label' => 'ประเภทขยะ'],
                ['link' => $adminBase . 'businesses/businesses.php', 'icon' => 'fas fa-store', 'label' => 'ธุรกิจในชุมชน'],
                ['link' => $adminBase . 'business_types/business_types.php', 'icon' => 'fas fa-tags', 'label' => 'ประเภทธุรกิจ'],
                ['link' => $adminBase . 'businesses_photos/businesses_photos.php', 'icon' => 'fas fa-images', 'label' => 'ภาพโปรโมทธุรกิจ'],
                ['icon' => 'fas fa-cogs', 'label' => 'API', 'submenu' => [
                    ['link' => $adminBase . 'API/upload_Hero.php', 'label' => 'เปลี่ยน Hero'],
                    ['link' => $adminBase . '1/show_cards.php', 'label' => 'เปลี่ยน cartหน้าindex'],
                    ['link' => $adminBase . 'API/beach_content.php', 'label' => 'เปลี่ยน cartข้อมูลหาดทรายน้อย'],
                    ['link' => $adminBase . 'API/project_manager.php', 'label' => 'เปลี่ยน ที่มาของโครงการ'],
                    ['link' => $adminBase . 'API/อัพโหลดภาพรวม.php', 'label' => 'เปลี่ยน ภาพรวม'],
                ]],
                ['link' => $adminBase . 'logout.php', 'icon' => 'fas fa-sign-out-alt', 'label' => 'ออกจากระบบ', 'bgColor' => 'from-red-600 to-red-500']
            ];
