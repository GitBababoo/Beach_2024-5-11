    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group" id="link-field" style="display: none;">
            ...
            <select class="form-control" id="link" name="link">
                ...
                <option value="../../ข้อมูลหาดทรายน้อย.php">ข้อมูลหาดทรายน้อย</option>
                <option value="../../ที่มาโครงการ.php">ที่มาโครงการ</option>
                <option value="../../ภาพบรรยากาศโครงการ.php">ภาพบรรยากาศโครงการ</option>
                <option value="../../ธุรกิจชุมชน.php">ธุรกิจชุมชน</option>
            </select>
        </div>
        <div class="form-group">
