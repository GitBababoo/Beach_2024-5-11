        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="link" name="link">
                    ...
                    <option value="../../ข้อมูลหาดทรายน้อย.php" <?php echo $card['link'] == '../../ข้อมูลหาดทรายน้อย.php' ? 'selected' : ''; ?>>ข้อมูลหาดทรายน้อย</option>
                    <option value="../../ที่มาโครงการ.php" <?php echo $card['link'] == '../../ที่มาโครงการ.php' ? 'selected' : ''; ?>>ที่มาโครงการ</option>
                    <option value="../../ภาพบรรยากาศโครงการ.php" <?php echo $card['link'] == '../../ภาพบรรยากาศโครงการ.php' ? 'selected' : ''; ?>>ภาพบรรยากาศโครงการ</option>
                    <option value="../../ธุรกิจชุมชน.php" <?php echo $card['link'] == '../../ธุรกิจชุมชน.php' ? 'selected' : ''; ?>>ธุรกิจชุมชน</option>
                </select>
            </div>
            <div class="form-group">
